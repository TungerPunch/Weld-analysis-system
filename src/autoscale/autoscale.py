from src.autoscale.find_bar_functions import load_model, get_scale_img
...
pytesseract.pytesseract.tesseract_cmd = r'src\autoscale\tesseract\tesseract.exe'

model = load_model(r'models\find_bar.pt')
...
def autoscale(image):
    ...
    scale = get_scale_img(model, image)
