...
class Parameters_finder:
    ...
    def __init__(self, image, model, mm_in_pixel):
        # Изображение
        self.image = image
        # Результат работы сегментационной модели
        self.results = model(self.image)
        # Коэффициент масштаба
        self.mm_in_pixel = mm_in_pixel
    ...
    def find_sagging(self):
        ...
        # Если сэггинга нет, то его значение 0
